/**
 * @file 200_qsort_fib_prime_bsearch_structmalloc.c
 * @author dangjinghao (dangjinghaoemail@163.com)
 * @brief this testcase is used to test basic algorithms and data structures:
 *        prime number, fibonacci, factorial, quick sort, binary search,
 *        linked list, malloc/free function.
 * @date 2025-04-09
 * 
 * @copyright Copyright (c) 2025 dangjinghao
 * 
 */
#include <stdio.h>
#include <stdlib.h>
