...
static char *NodeKind_string[] = {
    ...
    array_string_item(ND_PTR_SUB),    array_string_item(ND_SA_ADD),
    array_string_item(ND_SA_SUB),     array_string_item(ND_SA_PTR_ADD),
    array_string_item(ND_SA_PTR_SUB), array_string_item(ND_SA_MUL),
    array_string_item(ND_SA_DIV),     array_string_item(ND_SA_MOD),
    array_string_item(ND_SA_BITAND),  array_string_item(ND_SA_BITOR),
    array_string_item(ND_SA_BITXOR),  array_string_item(ND_SA_SHL),
    array_string_item(ND_SA_SHR),     array_string_item(ND_ALLOCA),
    array_string_item(ND_VA_START),   array_string_item(ND_VA_END),
    array_string_item(ND_VA_COPY),    array_string_item(ND_POST_DEC),
    array_string_item(ND_POST_INC),
};
